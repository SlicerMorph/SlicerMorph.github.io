...
4.     Follow steps 4 and 5 of Method 1 to adjust the endocast to fill the full volume of the cranial cavity and tidy up any overflow. Just remember when using the *Margin* tool to set the *Editable area* back to the default *Everywhere*, and when using the *Scissors* to set them back to *Erase inside*.
